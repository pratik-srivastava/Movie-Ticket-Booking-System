...
def timing(a): 
    ...
    if a == 1: 
        ...
        print("Your Ticket has been booked successfull!, enjoy your movie at "+x)
       # print("\n")
       ...
       # print("\n")
        ...
        print("Your Tickets has been booked successfull!, enjoy your movie at "+x)
        #print("\n")
...
def city():
    ...
    print("                           Welcome to Movie Ticket Booking Portal                           ")
